...
class AlbumControllerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetAlbumRepositoryReturnsAnInstanceOfAlbumRepository()
    {
        $this->assertInstanceOf('Album\Repository\AlbumRepository', $this->controller->getAlbumRepository());
    }
}